-- ============================================================================
-- 0033_tribute_render_outputs.down.sql  -- revert 0033
-- Restores the 0030 tribute_status view + status set, drops the render columns.
-- ============================================================================
...
ALTER TABLE tributes DROP COLUMN IF EXISTS render_error;
ALTER TABLE tributes DROP COLUMN IF EXISTS rendered_at;
ALTER TABLE tributes DROP COLUMN IF EXISTS pdf_url;
