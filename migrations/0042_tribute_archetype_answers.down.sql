-- ============================================================================
-- 0042 down: restore the 0040 view (theme-row answers only) and drop the
-- per-campaign answers column.
-- ============================================================================

BEGIN;

-- view first: the 0042 view references the column being dropped
DROP VIEW IF EXISTS tribute_status;

ALTER TABLE tributes DROP COLUMN IF EXISTS archetype_answers;
